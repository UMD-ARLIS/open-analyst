...
export function ProjectLeftPanel() {
  ...
  return (
    <aside className="relative shrink-0 border-r border-border bg-surface" style={{ width }}>
      <div
      ...
      <div className="h-full overflow-hidden">
        {panel === 'settings' ? (
          ...
          <ThreadContextPanel projectId={projectId} workspaceContext={workspaceContext} />
        )}
      </div>
    </aside>
  );
