...
export function DocumentPreview({
  ...
  const isPdf =
    mimeType.toLowerCase().includes('pdf') || document.title.toLowerCase().endsWith('.pdf');
  ...
  const pdfPreviewUrl = useArtifactObjectUrl(
    artifactUrl,
    showArtifactPreview && isPdf && hasArtifact
  );
