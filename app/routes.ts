...
export default [
  layout("routes/_app.tsx", [
    ...
    route("projects/:projectId/runs/:runId", "routes/_app.projects.$projectId.runs.$runId.tsx"),
    ...
    route("projects/:projectId/canvas", "routes/_app.projects.$projectId.canvas.tsx"),
  ...
  ...prefix("api", [
    ...
    route("projects/:projectId/runs/:runId/steps", "routes/api.projects.$projectId.runs.$runId.steps.ts"),
    route("projects/:projectId/runs/:runId/stream", "routes/api.projects.$projectId.runs.$runId.stream.ts"),
    route("projects/:projectId/runs/:runId/interrupt", "routes/api.projects.$projectId.runs.$runId.interrupt.ts"),
    route("projects/:projectId/runs/:runId/approve", "routes/api.projects.$projectId.runs.$runId.approve.ts"),
